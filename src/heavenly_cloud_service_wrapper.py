...
class HeavenlyCloudServiceWrapper(object):
    ...
    def deploy_angel(context, cloudshell_session, cloud_provider_resource,deploy_app_action, cancellation_context):
        ...
        decrypted_input_password = cloudshell_session.DecryptPassword(deploy_app_action.actionParams.appResource.attributes['Password']).Value

        new_pass = HeavenlyCloudService.create_new_password(cloud_provider_resource,input_user,decrypted_input_password)
        ...
        try:
            ...
            return DeployAppResult(actionId=deploy_app_action.actionId, success=False, errorMessage=traceback.format_exc())
        ...
        deployed_app_attributes.append(Attribute('Password',new_pass))
    ...
    def connect(logger, cloud_provider_resource, set_vlan_action):
        ...
        try:
            ...
            logger.info('requested vnic name: ' + vnic_name)
    ...
    def disconnect(cloud_provider_resource, remove_vlan_action):
        ...
        try:
            ...
            return RemoveVlanResult(actionId=remove_vlan_action.actionId, success=False,errorMessage=traceback.format_exc())
